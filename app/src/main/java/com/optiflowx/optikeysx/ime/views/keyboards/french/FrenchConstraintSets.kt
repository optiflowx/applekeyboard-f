package com.optiflowx.optikeysx.ime.views.keyboards.french
...
class FrenchConstraintSets(keyHeight: Dp, rowHeight: Dp) {
    ...
    val firstRowConstraints = ConstraintSet {
        ...
        createHorizontalChain(
            a, gap, z, gap2, e, gap3, r, gap4, t, gap5, y, gap6, u, gap7, i, gap8, o, gap9, p,
    ...
    val secondRowConstraints = ConstraintSet {
        ...
        createHorizontalChain(
            q, gap, s, gap2, d, gap3, f, gap4, g, gap5, h, gap6, j, gap7, k, gap8, l,
            chainStyle = ChainStyle.Packed
        )
    }
