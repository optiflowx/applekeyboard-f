...
import com.optiflowx.optikeysx.app.screens.KeyboardsScreen
import com.optiflowx.optikeysx.app.screens.featurerequest.FeatureRequestsScreen
import com.optiflowx.optikeysx.app.screens.speech.VoiceRecognitionSettingsScreen
...
fun GeneralSection(
    ...
    CupertinoSection(
        ...
        SectionLink(
            ...
            onClick = { navigator.push(com.optiflowx.optikeysx.app.screens.KeyboardFontsScreen()) }
        )
        SectionLink(
            title = {
                CupertinoText(
